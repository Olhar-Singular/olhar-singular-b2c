...
/** Map an ordered mark list + optional color + optional fontSize (pt) to a react-pdf text Style. */
export function marksToPdfStyle(marks?: Mark[], color?: string, fontSize?: number): Style {
  const style: Style = {};
