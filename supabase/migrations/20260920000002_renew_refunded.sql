-- =============================================================================
-- renew_subscription: an external refund / chargeback behaves like our own
-- self-service refund
-- -----------------------------------------------------------------------------
-- MP can report payment_status 'refunded' or 'charged_back' on an
-- authorized_payment when support refunds the charge directly in the MP
-- panel, or the cardholder's bank reverses it. Before this guard that just
-- looked like "not paid" to renew_subscription: a live confirmed subscription
