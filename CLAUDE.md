...
conta nasce pelo checkout pago, pelo teste de 7 dias com cartão (sem cobrança até o 8º dia) ou
por convite do admin (trial 7 dias/50 créditos). Stack idêntica ao
